...
function seedWallets() {
  ...
  const seeds = [
    ...
    w('Drake', 'MUSICIAN', 'PUBLIC', 'FULL', 'CA', { entityCategory: 'Hip-Hop Artist', badges: ['KYC', 'VR', 'ASCAP'], professionalLicense: 'ASCAP-DRK-2025', balancePublic: false }),
    w('MrBeast', 'INFLUENCER', 'PUBLIC', 'FULL', 'US', { entityCategory: 'Content Creator', badges: ['KYC', 'KYB', 'PRO'], professionalLicense: 'YT-PARTNER-PREMIUM' }),
    ...
    w('OpenAI Foundation', 'DEVELOPER', 'PUBLIC', 'FULL', 'US', { entityCategory: 'AI Research', badges: ['KYC', 'KYB', 'LEI', 'AUDIT'], professionalLicense: 'OSS-AUDIT-2025-001' }),
