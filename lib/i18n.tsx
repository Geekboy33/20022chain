...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "tech.s4": "Finalize", "tech.s4d": "ArchPoS consensus commits the block in 400ms with instant finality. No rollbacks, no reorgs. Settlement is final.",
  ...
  es: {
    ...
    "tech.s4": "Finalizar", "tech.s4d": "El consenso ArchPoS confirma el bloque en 400ms con finalidad instantánea. Sin reversiones. La liquidación es final.",
  ...
  ar: {
    ...
    "tech.s1": "إرسال", "tech.s1d": "يوقع المستخدم معاملة من أي محفظة أو واجهة برمجة.", "tech.s2": "التحقق", "tech.s2d": "تدخل المعاملة مجمع DAG للتحقق من تنسيق ISO 20022.", "tech.s3": "التنفيذ", "tech.s3d": "محرك التنفيذ المتوازي يعالج المعاملة مع آلاف أخرى.", "tech.s4": "الإنهاء", "tech.s4d": "إجماع ArchPoS يؤكد الكتلة في 400 مللي ثانية مع نهائية فورية.",
  ...
  zh: {
    ...
    "tech.s1": "提交", "tech.s1d": "用户从任何钱包或API签署交易。", "tech.s2": "验证", "tech.s2d": "交易进入DAG内存池，验证ISO 20022格式。", "tech.s3": "执行", "tech.s3d": "并行执行引擎同时处理数千笔交易。", "tech.s4": "最终确认", "tech.s4d": "ArchPoS共识在400ms内确认区块，具有即时最终性。",
  ...
  pt: {
    ...
    "tech.s1": "Enviar", "tech.s1d": "O usuário assina uma transação de qualquer carteira ou API.", "tech.s2": "Validar", "tech.s2d": "A transação é validada no formato ISO 20022.", "tech.s3": "Executar", "tech.s3d": "O motor paralelo processa milhares de transações.", "tech.s4": "Finalizar", "tech.s4d": "O consenso ArchPoS confirma o bloco em 400ms.",
